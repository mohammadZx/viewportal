...
@section('content')
<div class="card-header">افزودن کوپن</div>
...
<div class="card-body">
    <form action="{{route('coupon.store')}}" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="discount" type="number" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ old('discount') }}" required autocomplete="off" autofocus>
        ...
        <div class="form-group">
            ...
            <input type="radio" required value="percent" @if(old('type') == 'percent') checked  @endif @if(!old('type')) checked @endif name="type" id="type">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label for="type2">ثابت</label>
            <input type="radio" required value="static" @if(old('type') == 'static') checked  @endif name="type" id="type2">
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="expire_at" data-jdp class="form-control @error('expire_at') is-invalid @enderror" name="expire_at" value="{{ old('expire_at') }}" autocomplete="off" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="coupon_use" placeholder="0 به معنی بی نهایت" type="number" class="form-control @error('coupon_use') is-invalid @enderror" name="coupon_use" value="{{ old('coupon_use') }}" autocomplete="off" autofocus>
