...
<div class="form-group row">
    ...
    <input id="tech" type="text" class="form-control @error('tech') is-invalid @enderror" name="tech" value="{{ old('tech') ? old('tech') : $comment->tech }}" required>
       @error('tech')
...
<label for="interpretation" class="text-md-right">interpretation <strong class="text-danger">*</strong></label>
    <textarea name="interpretation" id="interpretation" class="form-control @error('interpretation') is-invalid @enderror" name="interpretation" required>{{ old('interpretation') ? old('interpretation') : $comment->interpretation }}</textarea>
...
<div class="form-group row">
    ...
    <input id="diagnosis" type="text" class="form-control @error('diagnosis') is-invalid @enderror" name="diagnosis" value="{{ old('diagnosis') ? old('diagnosis') : $comment->diagnosis }}" required>
       @error('diagnosis')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
...
<div class="form-group row">
    ...
    <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" name="content" required>{{ old('content') ? old('content') : $comment->content }}</textarea>
    @error('content')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
